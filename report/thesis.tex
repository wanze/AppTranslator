...
\begin{center}
\(V_1\) = [ the settings ] \(^0\) [ to ] \(^{2}\)

\(V_2\) = [ the ] \(^{1}\) [ settings to ] \(^0\)
\end{center}

\item \(T\) = [ ouvrir ... vers modifier votre nom d'utilisateur ] ; \(S\) = [ the settings ]
...
Finally, we derived the following sentence: ``ouvrir les param\`{e}tres vers modifier votre nom d'utilisateur''

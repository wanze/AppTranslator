...
How can we automatically measure the quality of machine translated text? There exists an algorithm called ``BLEU'' \cite{bleu_score} which is mostly used for this task. The first section describes shortly how BLEU works, the second presents the BLEU scores achieved for the different translation systems.

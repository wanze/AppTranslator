...
\item Scoring phrases by computing the phrase translation probability \(\phi(\bar{f}|\bar{e})\) and building a phrase table. Here is an example how the content of the phrase table is organized in Moses for the English-French language pair:

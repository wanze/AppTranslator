...
\end{lstlisting}
We specify the path to the ``moses.ini'' configuration file and set the verbosity level to 2 (middle) to get some additional information from the decoder. We used histogram pruning with a stack size of 100 and the optimal model weights after tuning.
